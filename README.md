...
```
https://overlay.hyldrazolxy.fr/?scsk=reselim&scpos=top-right&scsc=0.8
```
becomes
```
https://hyldrazolxy-overlay.bakas.io/?scsk=reselim&scpos=top-right&scsc=0.8
```
...
### 2026-03-07
Fixed the DNSSEC issues preventing DNS record from being resolved on DNS providers like CloudFlare.
Thanks XxRikuShimizuxX for flagging this!

For site issues on this new deployment contact [BakaSoniji](https://discordapp.com/users/105067304559083520) on discord (I will add this to the website itself too)
